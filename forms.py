...
class DriverSignUpForm(Form):
    ...
    birth_day = StringField("birth_day", [validators.Length(min=4, max=25)])
    driving_licence = StringField("driving_licence", [validators.Length(min=4, max=25)])
    ...
    vehicle_brand = StringField("vehicle_brand", [validators.Length(min=4, max=25)])
    vehicle_model = StringField("vehicle_model", [validators.Length(min=4, max=25)])
...
class LoginForm(Form):
    ...
    #TODO validation
    ID = StringField("Id", [validators.Length(min=4, max=25)])
    password =PasswordField("adress", [validators.Length(min=4, max=25)])
